...
![Decision tree classifier](/lectures/files/interpretable-features/decision_tree.png)
...
![Automatically engineered features are not interpretable](/lectures/files/interpretable-features/engineered_importance.png)

![Original basic features are interpretable](/lectures/files/interpretable-features/interpret_importance.png)
...
![Characteristics of interpretable features](/lectures/files/interpretable-features/table.png)
...
1. Show users one painting by each artist, and ask them to identify which artist they believe painted each: <br><br><img src="/lectures/files/interpretable-features/monet_lillies_vs_sisley.jpg" alt="A painting by Monet and a painting by someone else"/><br>
...
![Pyreal transforming raw features into interpretable features](/lectures/files/interpretable-features/pyreal_transforms.png)
...
![Mind the Gap algorithm, showing a bigger gap in the left feature group](/lectures/files/interpretable-features/gap_example.png)
...
![MTG example feature groups](/lectures/files/interpretable-features/mtg.png)
