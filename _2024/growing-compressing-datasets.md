...
last_year: /2023/growing-compressing-datasets/
---
...
![!Overview of active learning](lec6.001.png)
...
![End-to-end training time for core-set selection with selection via proxy on CIFAR10](lec6.005.png)
